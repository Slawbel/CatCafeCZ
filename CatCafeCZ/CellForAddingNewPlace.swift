...
class CellForAddingNewPlace: UITableViewCell {
    ...
    func setuptNameCell () {
        ...
        self.addNameLabel.font = UIFont.systemFont(ofSize: 18, weight: .semibold)
 
        self.addNameTF.attributedPlaceholder = NSAttributedString(string: " Enter name of place here", attributes: [NSAttributedString.Key.foregroundColor : UIColor.lightGray])
        ...
        addNameTF.snp.makeConstraints{ make in
            make.top.equalTo(addNameLabel.snp.bottom).offset(5)
    ...
    func setuptLocationCell () {
        ...
        self.addLocationLabel.font = UIFont.systemFont(ofSize: 18, weight: .semibold)
 
        self.addLocationTF.attributedPlaceholder = NSAttributedString(string: " Enter location of place here", attributes: [NSAttributedString.Key.foregroundColor : UIColor.lightGray])
        ...
        addLocationTF.snp.makeConstraints{ make in
            make.top.equalTo(addLocationLabel.snp.bottom).offset(5)
            make.leading.trailing.bottom.equalToSuperview().inset(10)
        }
    }
    ...
    func setuptTypeCell () {
        ...
        self.addTypeLabel.font = UIFont.systemFont(ofSize: 18, weight: .semibold)
 
        self.addTypeTF.attributedPlaceholder = NSAttributedString(string: " Enter type of place here", attributes: [NSAttributedString.Key.foregroundColor : UIColor.lightGray])
        ...
        addTypeTF.snp.makeConstraints{ make in
            make.top.equalTo(addTypeLabel.snp.bottom).offset(5)
            make.leading.trailing.bottom.equalToSuperview().inset(10)
        }
    }
